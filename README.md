...
- I then saved all of this to the "scenes" folder in our godot project. So, we now have a model called "platform_6x6x4" under the "models" folder and a scene named the same under the scenes folder. This is to keep from editing the actual models and rather use new scenes so that we can add different nodes to them like the collision shapes without breaking anything. 
